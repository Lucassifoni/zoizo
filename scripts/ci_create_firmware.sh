...
FULL_FIRMWARE_FILENAME="scope_${MIX_TARGET}.fw"
FULL_FIRMWARE_PATH="$DEPLOY_PATH/$FULL_FIRMWARE_FILENAME"
PREVIOUS_FIRMWARE_FILENAME="previous_${MIX_TARGET}.fw"
PREVIOUS_FIRMWARE_URL=https://github.com/scope/scope/releases/latest/download/scope_${MIX_TARGET}.fw
SCRIPT_DIR=$(dirname "${BASH_SOURCE[0]}")

# Copy the firmware out of the build directory
cp "_build/${MIX_TARGET}_${MIX_ENV}/nerves/images/scope.fw" "$FULL_FIRMWARE_PATH"
